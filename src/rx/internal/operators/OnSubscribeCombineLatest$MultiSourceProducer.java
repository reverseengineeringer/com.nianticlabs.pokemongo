...
final class OnSubscribeCombineLatest$MultiSourceProducer<T, R>
  implements Producer
{
  ...
  public OnSubscribeCombineLatest$MultiSourceProducer(Subscriber<? super R> paramSubscriber, List<? extends Observable<? extends T>> paramList, FuncN<? extends R> paramFuncN)
  {
    sources = paramList;
...
/* Location:
 * Qualified Name:     rx.internal.operators.OnSubscribeCombineLatest.MultiSourceProducer
