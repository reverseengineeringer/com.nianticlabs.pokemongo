...
final class OnSubscribeJoin$ResultSink
{
  ...
  public void run()
  {
    ...
    this$0.left.unsafeSubscribe(localLeftSubscriber);
    this$0.right.unsafeSubscribe(localRightSubscriber);
  }
    ...
    extends Subscriber<TLeft>
  {
    ...
    public void onNext(TLeft paramTLeft)
    {
      ...
      synchronized (guard)
      {
        ...
        try
        {
          ??? = (Observable)this$0.leftDurationSelector.call(paramTLeft);
      ...
      while (((Iterator)???).hasNext())
      {
        ...
        localObject2 = this$0.resultSelector.call(paramTLeft, localObject2);
    ...
    extends Subscriber<TRight>
  {
    ...
    public void onNext(TRight paramTRight)
    {
      ...
      synchronized (guard)
      {
        ...
        try
        {
          ??? = (Observable)this$0.rightDurationSelector.call(paramTRight);
      ...
      {
        localObject2 = ((Iterator)???).next();
        localObject2 = this$0.resultSelector.call(localObject2, paramTRight);
        subscriber.onNext(localObject2);
      }
    }
