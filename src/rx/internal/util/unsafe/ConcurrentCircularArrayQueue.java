  ...
  extends ConcurrentCircularArrayQueueL0Pad<E>
{
  ...
  public ConcurrentCircularArrayQueue(int paramInt)
  {
    ...
    mask = (paramInt - 1);
    buffer = ((Object[])new Object[(paramInt << SPARSE_SHIFT) + 64]);
  }
  
  protected final long calcElementOffset(long paramLong)
  {
    return calcElementOffset(paramLong, mask);
  }
  ...
  {
    return (E)lpElement(buffer, paramLong);
  }
  ...
  {
    return (E)lvElement(buffer, paramLong);
  }
  ...
  {
    soElement(buffer, paramLong, paramE);
  }
  ...
  {
    spElement(buffer, paramLong, paramE);
  }
