  ...
  implements Serializable
{
  ...
  {
    _parser = paramTypeParser.withFactory(this);
    _modifiers = paramArrayOfTypeModifier;
    _classLoader = paramClassLoader;
  }
  ...
  {
    return new TypeFactory(_parser, _modifiers, paramClassLoader);
  }
  ...
  public TypeFactory withModifier(TypeModifier paramTypeModifier)
  {
    ...
    if (_modifiers == null)
    {
      TypeParser localTypeParser = _parser;
      ClassLoader localClassLoader = _classLoader;
      return new TypeFactory(localTypeParser, new TypeModifier[] { paramTypeModifier }, localClassLoader);
    }
    return new TypeFactory(_parser, (TypeModifier[])ArrayBuilders.insertInListNoDup(_modifiers, paramTypeModifier), _classLoader);
  }
}
