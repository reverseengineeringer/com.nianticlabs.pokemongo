  ...
  implements Versioned, Serializable
{
  ...
  protected ObjectReader(ObjectMapper paramObjectMapper, DeserializationConfig paramDeserializationConfig, JavaType paramJavaType, Object paramObject, FormatSchema paramFormatSchema, InjectableValues paramInjectableValues)
  {
    ...
    _rootDeserializer = _prefetchRootDeserializer(paramJavaType);
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      if ((localObject == JsonToken.END_ARRAY) || (localObject != JsonToken.END_OBJECT))
      {
        ...
        if (_unwrapRoot) {
          paramObject = _unwrapAndDeserialize(paramJsonParser, (DeserializationContext)localObject, _valueType, localJsonDeserializer);
  ...
  {
    if ((_filter == null) || (FilteringParserDelegate.class.isInstance(paramJsonParser))) {
      return paramJsonParser;
    }
    return new FilteringParserDelegate(paramJsonParser, _filter, false, false);
  }
    ...
    throws JsonMappingException
  {
    ...
    do
    {
      ...
      localJavaType = _valueType;
      if (localJavaType == null) {
        throw new JsonMappingException("No value type configured for ObjectReader");
      }
      localJsonDeserializer = (JsonDeserializer)_rootDeserializers.get(localJavaType);
    ...
    _rootDeserializers.put(localJavaType, paramDeserializationContext);
  ...
  {
    return new MappingIterator(_valueType, paramJsonParser, paramDeserializationContext, paramJsonDeserializer, paramBoolean, _valueToUpdate);
  }
  ...
  protected JsonDeserializer<Object> _prefetchRootDeserializer(JavaType paramJavaType)
  {
    ...
    for (;;)
    {
      return localJsonDeserializer1;
      label25:
      localJsonDeserializer2 = (JsonDeserializer)_rootDeserializers.get(paramJavaType);
      localJsonDeserializer1 = localJsonDeserializer2;
      if (localJsonDeserializer2 == null)
      {
        localJsonDeserializer1 = localJsonDeserializer2;
        try
        {
          ...
          {
            localJsonDeserializer1 = localJsonDeserializer2;
            _rootDeserializers.put(paramJavaType, localJsonDeserializer2);
  ...
  protected Object _unwrapAndDeserialize(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext, JavaType paramJavaType, JsonDeserializer<Object> paramJsonDeserializer)
    throws IOException
  {
    String str1 = _config.findRootName(paramJavaType).getSimpleName();
  ...
  {
    return _context.createInstance(_config, paramJsonParser, _injectableValues);
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndCloseAsTree(_considerFilter(_parserFactory.createParser(paramInputStream)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndCloseAsTree(_considerFilter(_parserFactory.createParser(paramReader)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndCloseAsTree(_considerFilter(_parserFactory.createParser(paramString)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramFile)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramInputStream)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramReader)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramString)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramURL)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramArrayOfByte)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return (T)_bindAndClose(_considerFilter(_parserFactory.createParser(paramArrayOfByte, paramInt1, paramInt2)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndReadValues(_considerFilter(_parserFactory.createParser(paramFile)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndReadValues(_considerFilter(_parserFactory.createParser(paramInputStream)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    paramReader = _considerFilter(_parserFactory.createParser(paramReader));
    ...
    throws IOException, JsonProcessingException
  {
    ...
    paramString = _considerFilter(_parserFactory.createParser(paramString));
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndReadValues(_considerFilter(_parserFactory.createParser(paramURL)));
  }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    return _bindAndReadValues(_considerFilter(_parserFactory.createParser(paramArrayOfByte)));
  }
  ...
  {
    return _with(_config.withRootName(paramPropertyName));
  }
  
  public ObjectReader withRootName(String paramString)
  {
    return _with((DeserializationConfig)_config.withRootName(paramString));
  }
