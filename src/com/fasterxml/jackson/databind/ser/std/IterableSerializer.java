  ...
  extends AsArraySerializerBase<Iterable<?>>
{
  ...
  {
    return new IterableSerializer(this, _property, paramTypeSerializer, _elementSerializer, _unwrapSingle);
  }
  ...
  public final void serialize(Iterable<?> paramIterable, JsonGenerator paramJsonGenerator, SerializerProvider paramSerializerProvider)
    throws IOException
  {
    if (((_unwrapSingle == null) && (paramSerializerProvider.isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED))) || ((_unwrapSingle == Boolean.TRUE) && (hasSingleElement(paramIterable))))
    {
    ...
    for (;;)
    {
      ...
      while (!localIterator.hasNext())
      {
        ...
        for (;;)
        {
          ...
          break;
          label129:
          localObject2 = paramSerializerProvider.findValueSerializer((Class)localObject3, _property);
