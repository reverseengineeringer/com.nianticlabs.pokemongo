  ...
  extends AsArraySerializerBase<Iterator<?>>
{
  ...
  {
    return new IteratorSerializer(this, _property, paramTypeSerializer, _elementSerializer, _unwrapSingle);
  }
  ...
  public final void serialize(Iterator<?> paramIterator, JsonGenerator paramJsonGenerator, SerializerProvider paramSerializerProvider)
    throws IOException
  {
    if (((_unwrapSingle == null) && (paramSerializerProvider.isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED))) || ((_unwrapSingle == Boolean.TRUE) && (hasSingleElement(paramIterator))))
    {
    ...
    for (;;)
    {
      ...
      while (!paramIterator.hasNext())
      {
        ...
        for (;;)
        {
          ...
          break;
          label123:
          localObject3 = paramSerializerProvider.findValueSerializer((Class)localObject4, _property);
