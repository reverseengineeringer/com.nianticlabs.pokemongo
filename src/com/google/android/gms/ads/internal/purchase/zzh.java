...
public class zzh
{
  ...
  {
    zzCX = new zza(paramContext, "google_inapp_purchase.db");
  }
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = zzCX.getWritableDatabase();
  ...
  public void zza(zzf paramzzf)
  {
    ...
    localSQLiteDatabase.delete("InAppPurchase", String.format(Locale.US, "%s = %d", new Object[] { "purchase_id", Long.valueOf(zzCQ) }), null);
  }
  ...
  public void zzb(zzf paramzzf)
  {
    ...
    localContentValues.put("product_id", zzCS);
    localContentValues.put("developer_payload", zzCR);
    localContentValues.put("record_time", Long.valueOf(SystemClock.elapsedRealtime()));
    zzCQ = localSQLiteDatabase.insert("InAppPurchase", null, localContentValues);
