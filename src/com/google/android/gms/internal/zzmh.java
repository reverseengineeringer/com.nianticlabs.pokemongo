...
abstract class zzmh<K, V>
{
    ...
    implements Set<Map.Entry<K, V>>
  {
    ...
    public boolean contains(Object paramObject)
    {
      ...
      return zzmf.equal(colGetEntry(i, 1), ((Map.Entry)paramObject).getValue());
    }
    ...
    implements Set<K>
  {
    ...
    public boolean containsAll(Collection<?> paramCollection)
    {
      return zzmh.containsAllHelper(colGetMap(), paramCollection);
    }
    ...
    public boolean removeAll(Collection<?> paramCollection)
    {
      return zzmh.removeAllHelper(colGetMap(), paramCollection);
    }
    
    public boolean retainAll(Collection<?> paramCollection)
    {
      return zzmh.retainAllHelper(colGetMap(), paramCollection);
    }
    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      paramObject = (Map.Entry)paramObject;
      if ((zzmf.equal(((Map.Entry)paramObject).getKey(), colGetEntry(mIndex, 0))) && (zzmf.equal(((Map.Entry)paramObject).getValue(), colGetEntry(mIndex, 1)))) {}
      for (;;)
      {
        return bool;
        bool = false;
