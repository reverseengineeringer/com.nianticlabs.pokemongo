  ...
  implements Factory<String>
{
  ...
  public String get()
  {
    String str = module.providePublicKey((Context)contextProvider.get(), (UpsightLogger)loggerProvider.get());
    if (str == null) {
...
/* Location:
 * Qualified Name:     com.upsight.android.internal.PropertiesModule_ProvidePublicKeyFactory
