...
class MarketingContentActions$1$1
  implements MarketingContentActions.InternalFactory
{
  MarketingContentActions$1$1(MarketingContentActions.1 param1) {}
  ...
  {
    return new MarketingContentActions.Trigger(paramMarketingContentActionContext, paramString, paramJsonNode, null);
  }
}

/* Location:
 * Qualified Name:     com.upsight.android.marketing.internal.content.MarketingContentActions.1.1
